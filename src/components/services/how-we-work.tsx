...
export const HowWeWork = () => {
  const workSteps: WorkStep[] = [
    ...
    },
    {
      ...
      description: "The planning phase is where we map out the key features, technical requirements, and overall framework of your project. Our approach covers:",
      bulletPoints: [
      ...
      additionalText: "With a detailed roadmap in place, we minimize risks, streamline workflows, and maximize productivity.",
    ...
    },
    {
      ...
      description: "In this phase, we bring your vision to life through visually compelling, user-friendly, and functional designs. We focus on:",
      bulletPoints: [
        "Intuitive UX and experience (UX) design",
        "Wireframing & prototyping",
        "Seamless interaction design"
      ],
      additionalText: "Our goal is to deliver aesthetically pleasing, intuitive, and accessible product that reflects your brand and resonates with your audience.",
    ...
    },
    {
      ...
      description: "With a strong strategy and design in place, our expert developers build your digital solution. Depending on your business needs and complexity, we:",
      bulletPoints: [
      ...
      additionalText: "Our team ensures seamless integration with third-party applications, databases, and cloud platforms, meeting your app requirements.",
    ...
    },
    {
      ...
      description: "Before launch, our dedicated QA team rigorously tests the application across multiple parameters, including:",
      bulletPoints: [
        "Performance & load testing",
        "Integration & compatibility checks",
        "Bug detection & resolution"
      ],
      additionalText: "We deliver a fully optimized, usable, and market-ready product right after passing its verification stages.",
    ...
    },
    {
      ...
      description: "Once your app or website is launched, we ensure smooth deployment with manual or automated processes based on your business needs. Post-launch, we provide:",
      bulletPoints: [
        "Regular system & performance monitoring",
        "Timely updates & improvements",
        "Security patches & capability enhancements"
      ],
      additionalText: "Your success doesn't stop at launch—we help you evolve your product to adapt to competition, and reflect to fast-changing digital landscape.",
    ...
    <div className="py-16 bg-[#fffaf0]">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-[1px] bg-amber-300 hidden md:block"></div>
          ...
          <div className="space-y-16 md:space-y-28">
            {workSteps.map((step, index) => (
              <div key={index} className={`relative flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 z-10 hidden md:flex items-center justify-center w-24">
                ...
                {/* Content Side */}
                <div className={`w-full md:w-[45%] px-4 mb-8 md:mb-0 ${index % 2 === 0 ? 'md:pr-16 text-left md:text-left' : 'md:pl-16 text-left'}`}>
